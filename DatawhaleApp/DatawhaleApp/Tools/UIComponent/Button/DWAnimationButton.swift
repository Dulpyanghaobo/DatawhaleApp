//
//  DWAnimationButton.swift
//  DatawhaleApp
//
//  Created by 杨皓博 on 2021/11/26.
//

import UIKit

@IBDesignable
class DWAnimationButton: UIButton{
    ...
    open var onClickAction: ((DWAnimationButton)->Void)?
